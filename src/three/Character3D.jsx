...
function Ears({ sp }) {
  ...
  const outerEar = sp.panda ? '#111827' : body;
  if (ear === 'long') {
    return (
      <group>
        {[-0.11, 0.11].map((x) => (
  ...
  if (ear === 'round') {
    return (
      <group>
        {[-0.17, 0.17].map((x) => (
          <group key={x}>
            <Sp p={[x, 1.16, 0]} rad={0.1} c={outerEar} />
            <Sp p={[x, 1.16, 0.045]} rad={0.06} sc={[1, 1, 0.5]} c={sp.panda ? '#030712' : earIn} />
          </group>
        ))}
      </group>
    );
  ...
  if (ear === 'zebra') {
    return (
      <group>
        {[-0.16, 0.16].map((x) => (
          <group key={x}>
            <Sp p={[x, 1.27, 0]} rad={0.075} sc={[0.85, 1.45, 0.65]} c={body} />
            <Sp p={[x, 1.29, 0.04]} rad={0.045} sc={[0.7, 1.2, 0.45]} c={earIn} />
          </group>
        ))}
      </group>
    );
  ...
  if (ear === 'human') {
    return (
      <group>
        {[-0.28, 0.28].map((x) => <Sp key={x} p={[x, 1.0, 0]} rad={0.055} sc={[0.65, 1.1, 0.55]} c={body} />)}
      </group>
    );
  }
  if (ear === 'floppy') {
  ...
  // top (개구리 눈) — 노란 홍채와 발광 하이라이트로 안광을 표현해요.
  return (
    <group>
      {[-0.12, 0.12].map((x) => (
        <group key={x}>
          <Sp p={[x, 1.22, 0.02]} rad={0.09} c={sp.body} />
          <Sp p={[x, 1.24, 0.08]} rad={0.048} c="#fde68a" e="#facc15" />
          <Sp p={[x, 1.24, 0.12]} rad={0.02} c="#111827" />
          <Sp p={[x - 0.015, 1.255, 0.135]} rad={0.009} c="#ffffff" e="#ffffff" />
        </group>
      ))}
    </group>
  );
...
function Extras({ sp }) {
  ...
  return (
    <group>
      ...
      {/* 얼룩말은 앞면에도 세로 줄무늬를 넣어 북극곰처럼 보이지 않게 해요. */}
      {sp.zebra && (
        <group>
          {[-0.22, -0.13, 0.13, 0.22].map((x, i) => (
            <Sp key={i} p={[x, 0.42 + (i % 2) * 0.04, 0.245]} rad={0.04} sc={[0.7, 2.0, 0.35]} c="#111827" />
          ))}
          {[-0.16, 0.16].map((x) => (
            <Sp key={x} p={[x, 1.08, 0.25]} rad={0.035} sc={[0.7, 1.7, 0.35]} c="#111827" />
          ))}
        </group>
      )}
      {/* 너구리 눈가 무늬 */}
      ...
      {e === 'duck' && (
        <group>
          <Sp p={[-0.22, 0.55, 0.02]} rad={0.08} sc={[0.45, 1.15, 0.75]} c="#f59e0b" r={[0, 0, -0.35]} />
          <Sp p={[0.22, 0.55, 0.02]} rad={0.08} sc={[0.45, 1.15, 0.75]} c="#f59e0b" r={[0, 0, 0.35]} />
          <Sp p={[0, 1.2, -0.06]} rad={0.18} sc={[1.15, 0.35, 0.9]} c="#f59e0b" />
        </group>
      )}
      {e === 'human' && (
        <group>
          <Sp p={[0, 1.18, -0.01]} rad={0.23} sc={[1.08, 0.38, 0.95]} c="#5b3825" />
          <Sp p={[-0.2, 1.07, 0.03]} rad={0.06} sc={[0.6, 1.5, 0.7]} c="#5b3825" />
          <Sp p={[0.2, 1.07, 0.03]} rad={0.06} sc={[0.6, 1.5, 0.7]} c="#5b3825" />
        </group>
      )}
    </group>
  ...
  return (
    <group>
      ...
      {sp.panda && [-0.11, 0.11].map((x) => (
        <Sp key={x} p={[x, 1.03, 0.19]} rad={0.09} sc={[1.12, 1.08, 0.55]} c="#111827" />
      ))}
