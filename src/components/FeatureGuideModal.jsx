  ...
  student: {
    ...
    sections: [
      ...
      },
      {
        icon: '🎯',
        title: '오늘의 미션',
        body: '오늘의 미션 탭에서 선생님이 정한 미션 내용, 제한 시간, 상금을 확인할 수 있어요. 시간이 끝나기 전에 미션을 수행하고 완료 버튼을 누르면 선생님 확인 후 상금이 현금으로 지급돼요. 시간이 끝난 뒤에는 완료 버튼을 누를 수 없어요.',
      },
      {
        icon: '🪑',
        title: '자리 부동산',
      ...
      },
      {
        icon: '⚔️',
        title: '용사키우기',
        body: '용사 상점에서 소년·소녀 용사와 헬멧, 무기, 갑옷, 장갑, 신발, 장신구, 펫을 학급화폐로 구매해요. 장비를 착용하면 전투력이 올라가고, 희귀·엘리트·전설·초월 등급에는 특별 능력이 붙을 수 있어요. 펫의 치명타는 보스전에서 실제로 터졌을 때만 기본 2배 피해를 주며, 치명타 피해 +5%가 있으면 2.05배가 됩니다. 일반 공격·일반 몬스터 피해에는 2배가 적용되지 않아요. 100단계 몬스터에 도전하고 10단계마다 보스가 등장해요. 하루 기본 도전 횟수를 다 쓰면 추가 비용으로 더 도전할 수 있어요.',
      },
      {
        icon: '🥊',
        title: '친구 대결·칭호·이름',
  ...
  teacher: {
    ...
    sections: [
      ...
      },
      {
        icon: '📢',
        title: '경제 이벤트 발동',
        body: '설정 화면의 경제 이벤트 발동 영역에서 지원금, 금리, 대출, 주식시장, 물가, 세금, 학급 특별 이벤트를 선택할 수 있어요. 동시에 최대 3개까지 발동할 수 있으며, 학생 화면 맨 위 전광판에는 이벤트 설명과 구체적인 효과가 함께 표시됩니다. 지원금은 학생 현금에 적용되고, 금리·대출 이벤트는 은행 계산에 반영되며, 주식시장 이벤트는 시세에 실제 적용됩니다. 물가 이벤트는 상점·공간·용사 아이템 가격에 적용됩니다. 새로운 경제정책과 황금 경제 주간은 다음 이벤트 효과를 배수로 적용합니다.',
      },
      {
        icon: '🎯',
        title: '오늘의 미션 운영',
        body: '오늘의 미션 탭에서 제목·내용·제한 시간·상금을 정해 미션을 등록할 수 있어요. 학생이 제한 시간 안에 완료를 제출하면 학생별 완료 기록이 쌓이고, 선생님이 확인 버튼을 누른 순간 해당 학생 현금에 상금이 한 번만 지급됩니다. 시간이 지나면 학생 완료가 막히며, 필요한 경우 미션 카드에서 추가 시간을 분 단위로 설정할 수 있어요. 이미 제출된 기록은 시간이 지난 뒤에도 확인할 수 있습니다.',
      },
      {
        icon: '🐞',
        title: '건의함·버그 신고',
